...
status: PROPOSED_R3_FINAL_NONAUTHORITATIVE_TRACE
...
# MLFF D1/D2 Protocol-6.4 R3 definition dependency trace — final candidate
...
| `D2.DEF.038` | `D1.DEF.017`; `D2.AX.001`; `D2.DEF.019`; `D2.DEF.020`; `D2.DEF.021`; `D2.DEF.024` |
...
| `D2.DEF.051A` | `D1.DEF.020`; `D2.IMP.E0_HEADS` |
...
| `D2.AX.005` | `D1.AX.010`; `D2.DEF.041`; `D2.DEF.042`; `D2.DEF.051`; `D2.DEF.051A`; `D2.DEF.052`; `D2.DEF.053`; `D2.DEF.055`; `D2.DEF.058`; `D2.IMP.PRODUCTION` |
...
| `D2.DEF.062` | `D2.DEF.003`; `D2.DEF.004`; `D2.DEF.005`; `D2.DEF.006`; `D2.DEF.007`; `D2.DEF.009`; `D2.DEF.012`; `D2.DEF.013`; `D2.DEF.014`; `D2.DEF.017`; `D2.DEF.018`; `D2.DEF.023`; `D2.DEF.025`; `D2.DEF.033`; `D2.DEF.037`; `D2.DEF.038`; `D2.DEF.039`; `D2.DEF.041`; `D2.DEF.042`; `D2.DEF.051`; `D2.DEF.051A`; `D2.DEF.052`; `D2.DEF.054`; `D2.DEF.056`; `D2.DEF.057`; `D2.DEF.059`; `D2.DEF.060`; `D2.IMP.PRODUCTION` |
