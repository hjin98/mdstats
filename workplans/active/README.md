...
- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_D2_INDEPENDENT_REVIEW_HANDOFF.md` — historical Candidate-4 review handoff.\n- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_D2_INDEPENDENT_REVIEW_HANDOFF_C5.md` — current fresh independent D2 Review entrypoint pinned to immutable Candidate 5 `6e73fbb7af9b8d46f61cf81113259584ffed8527`; later branch descendants are lifecycle state only.
