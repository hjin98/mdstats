...
Implementation is blocked until the renewed D1 then D2 authority passes Protocol 6.4 review/ratification. R2 passed the prior D1 meaning, but the stakeholder subsequently amended foundation CV defaults to `75/75 meV/angstrom`. The R3 reconciliation now also states that CV authorization does not guarantee the tighter production checkpoint gate and gives `theta_CV` outer-verdict-only currentness. The existing `1:10:1` UniversalLoss coefficients are clarified, not changed. Fresh independent D1 Review R3 of exact target `d761171f3c86c3c79b87a90cfc02ac324c261b1a` (D1 blob `612294ec4680db01a18085e13fbfe5dcfa9fb7ed`) returned **PASS with no SERIOUS CHALLENGE**, and the stakeholder explicitly ratified that exact target on 2026-09-18. Gate B is closed. Independent D2 R1 review of `e2b39917ab8c16556eb218d6a41e9682331bbca0` returned **NO-PASS with no SERIOUS CHALLENGE to D1**. Fresh independent D2 R2 review of semantic target `4f161b1c4820de10abe638287b13152147d12fd9` (blob `3e7fb744fc733f23bbd93a8347246cfa306ebe89`) returned **PASS with no SERIOUS CHALLENGE**. The first renderer-only repair removed disallowed math macros, and a second representation-only repair now rewrites D2.DEF.027 to eliminate escaped set braces/restricted-sum syntax that still failed rendering. The final renderer-safe D2 ratification target is `32508991d472c1c6e4bd8b818b38d0880401845f` with D2 blob `30e6e6336cf41a05879650a3a2d7d583c4ef713a`; numerical semantics remain those of the independently reviewed R2 target. Repair record: `workplans/active/MLFF_REPLAY_RETENTION_TARGET_ADMISSIBILITY_D2_R2_RENDER_REPAIR_2.md`. D2 target `32508991d472c1c6e4bd8b818b38d0880401845f` is stakeholder-ratified as of 2026-09-18. Independent D3 Review R1 of candidate `119c4067b1852be127134d6b0fb1aae6cace4bd6` returned **NO-PASS**. The R1 repair now removes the training-identity/fitted-preparation cycle, freezes a single append-only terminal-unsealed legacy-seal exception, excludes D2.DEF.059B/publication-only ancestry from final-seed assessment currentness, and restores the full accepted P5 completion-proof/storage safety contract. Independent D3 Review R2 of exact target `5d7c62f803fc8757a4068b7b115fadb7a5ec4636` confirmed the four R1 D3 repairs but returned **NO-PASS with no SERIOUS CHALLENGE** because the D4 handoff still coupled held-out `outer_evaluation_artifact` / `outer_evaluation.extxyz*` to training materialization/root. The R2 handoff repair makes current `PostSelectionMaterialization` training-only, moves held-out serialization to EVAL2 attempt-local scratch outside the sealed root, persists only exact measurement evidence in the existing P5 evidence store, and preserves historical v2 roots read-only. Fresh independent Gate-D Review R3 of exact candidate `de360579686bd6f06eae8a6a5e26b232d7db847e` returns **PASS with no SERIOUS CHALLENGE**. Gate D is closed and the D3->D4 implementation workplan is authorized for Gate E; runtime implementation has not yet begun.
