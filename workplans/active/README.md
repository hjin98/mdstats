...
- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_WORKPLAN_REVIEW_R1.md` — **PASS AS WORKPLAN after Revision-2 repair**; the D2 numerical challenge itself remains open.
