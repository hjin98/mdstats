...
- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_D2_CANDIDATE.md` — proposed Stage-B Candidate 2. Persistent bias is controlled by fixed dtype centroid tolerances; stochastic spread is reference-anchored; TRAIN2 consequence is a two-update state-transition witness observed through portable e3nn. **Not accepted; fresh independent Review required.**
