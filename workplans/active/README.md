...
- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_WORKPLAN_REVIEW_R6.md` — **PASS AS WORKPLAN after Revision-7 repair**; supersedes R5/R4/R3/R2/R1. The D2 numerical challenge itself remains open.
