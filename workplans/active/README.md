...
- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_D2_INDEPENDENT_REVIEW_HANDOFF.md` — historical Candidate-4 review handoff.\n- `workplans/active/MLFF_TRAIN2_CUEQ_PARITY_REQUALIFICATION_D2_INDEPENDENT_REVIEW_HANDOFF_C5.md` — current fresh independent D2 Review entrypoint pinned to immutable Candidate 5 `be57964c15ed24e30372de407534efd8173d6bc5`; later branch descendants are lifecycle state only.
