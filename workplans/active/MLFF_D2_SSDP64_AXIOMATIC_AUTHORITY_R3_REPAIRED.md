...
parent_D1_candidate: workplans/active/MLFF_D1_SSDP64_AXIOMATIC_AUTHORITY_R3_REPAIRED.md
...
# Proposed MLFF D2 formal numerical authority kernel — repaired R3

## 1. Authority and exact import registry

This is the sole D2 file in the R3 semantic candidate. Every earlier D2 candidate listed above is authoring history only and does not compose with this candidate.

The candidate formalizes, without changing, accepted MLFF D2 at repository `hjin98/mdstats` basis `cb07d68372f1b6d25f9e8b62a2fb7e31fb82e824`. It remains proposed until fresh independent R3 review passes and the stakeholder ratifies the exact reviewed candidate.
...
Fresh independent R3 review must show lossless equivalence to accepted basis, continued closure of R1 findings, R2-B1 through R2-B4 closure, exact source availability for every imported prerequisite, definition-before-substantive-use closure, acyclic direct dependency trace, renderer-safe formulas, and correct downstream D4 conformance for D2.DEF.014. Any changed numerical result/decision, tolerance, failure classification, family/applicability set, stochastic exposure, or replay lineage is a semantic change requiring adjudication rather than editorial acceptance.