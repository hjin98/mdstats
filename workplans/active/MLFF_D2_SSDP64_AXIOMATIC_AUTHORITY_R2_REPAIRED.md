...
# Proposed MLFF D2 formal numerical authority kernel — repaired R2
...
The exact specialized imports used below are:
...
These imports are normative roots for accepted details not restated below. A definition below makes high-risk semantics formal-first but cannot change the imported accepted meaning.
