...
| `D1.DEF.016` | `D1.DEF.005`; `D1.DEF.008`; `D1.DEF.012`; `D1.DEF.014`; `D1.DEF.015`; `D1.IMP.ORDER` |
| `D1.DEF.017` | `D1.DEF.002`; `D1.DEF.009`; `D1.DEF.012`; `D1.DEF.014`; `D1.DEF.015`; `D1.DEF.016`; `D1.IMP.ORDER` |
...
| --- | --- | --- |
| target-order `0.95` | `D1.DEF.015`; `D2.DEF.019`; `D2.DEF.020`; `D2.DEF.029`; `D2.DEF.038` | fixed method coordinate |
...
| candidate/evaluation/fidelity/seed values | `D1.DEF.009`; `D1.AX.007`; `D1.DEF.023`; `D2.DEF.007`; `D2.DEF.034`; split/funnel/repair/monitor separation | configurable family under fixed structural domain |
