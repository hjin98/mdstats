...
status: PROPOSED_R2_FINAL_NONAUTHORITATIVE_TRACE
...
# MLFF D1/D2 Protocol-6.4 R2 definition dependency trace — final candidate
...
Exact root locators are those declared by the two scoped candidate files. The short names `D1.IMP.*`, `D2.IMP.*`, `D1.SRC.*`, and `D2.SRC.*` resolve only through those basis-pinned registries. There are no floating “accepted policy/provider” endpoints.

Authority direction is acyclic by construction: D1 objects depend only on D1 objects or exact D1 imports; D2 objects may depend on D1 objects and D2 objects/imports. No D1 object obtains meaning from its D2 concretization.
...
| `D1.DEF.011` | `D1.DEF.002`; `D1.DEF.010`; `D1.DEF.009`; `D1.IMP.P3` |
...
| `D1.DEF.017` | `D1.DEF.012`; `D1.DEF.015`; `D1.DEF.016`; `D1.DEF.002`; `D1.IMP.ORDER` |
| `D1.AX.006` | `D1.DEF.017`; `D1.DEF.011`; `D1.IMP.P3`; `D1.IMP.ORDER` |
| `D1.AX.007` | `D1.DEF.012`; `D1.DEF.015`; `D1.DEF.016`; `D1.IMP.ORDER` |
| `D1.DEF.018` | `D1.DEF.009`; `D1.DEF.017`; `D1.IMP.P3`; `D1.IMP.ORDER` |
| `D1.AX.008` | `D1.DEF.018`; `D1.DEF.011`; `D1.IMP.P3` |
...
| `D2.DEF.062` | `D2.DEF.003`; `D2.DEF.004`; `D2.DEF.005`; `D2.DEF.006`; `D2.DEF.007`; `D2.DEF.009`; `D2.DEF.012`; `D2.DEF.013`; `D2.DEF.014`; `D2.DEF.017`; `D2.DEF.018`; `D2.DEF.023`; `D2.DEF.025`; `D2.DEF.033`; `D2.DEF.037`; `D2.DEF.038`; `D2.DEF.039`; `D2.DEF.041`; `D2.DEF.042`; `D2.DEF.051`; `D2.DEF.052`; `D2.DEF.054`; `D2.DEF.056`; `D2.DEF.057`; `D2.DEF.059`; `D2.DEF.060`; `D2.IMP.PRODUCTION` |

The final `D2.DEF.062` row enumerates only definitions that directly contribute one of the typed failure members; it is not a global dependency shortcut.

## 4. High-risk D2 -> D1 concretization edges
...
These are D2 subject -> D1 prerequisite edges and therefore preserve abstraction direction. An attempted D2 change that cannot preserve its D1 prerequisite is an upward D1 Challenge.
