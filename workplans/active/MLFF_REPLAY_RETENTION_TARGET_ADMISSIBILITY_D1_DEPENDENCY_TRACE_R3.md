...
d1_candidate_blob: 93db84050e68ec5488282e75463556d02d0973af
scope:
...
| `D1.AX.010A` | `D1.DEF.022A`; `D1.DEF.025`; `D1.DEF.026`; `D1.DEF.027`; `D1.AX.009`; `D1.AX.010` | Threshold-only currentness semantics unchanged; changing CV thresholds reassesses CV descendants without retraining. |
...
3. whether making both CV ceilings looser can authorize a method whose fresh production systematically cannot meet the 50-meV target ceiling, and if so whether that is an acceptable screen/final distinction or a D1 defect;
4. whether the role-specific threshold edit remains assessment-only and cannot alter TRAIN2;
