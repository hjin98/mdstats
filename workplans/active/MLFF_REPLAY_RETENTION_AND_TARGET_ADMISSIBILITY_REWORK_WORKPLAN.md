...
- commit: `991d7bb21a798d5c0d1e94990ad298dde506a129`;
- D1 blob: `61cf2345e0d991b9598ba5a26fc58278c249cfb1`.

The representation-only edits flatten the three affected display equations so no display block contains a standalone `=` line, simplify the hard-admissible set braces, and convert every raw/backtick-wrapped inline LaTeX token in the amended replay section to proper `$...---
kind: abstraction-concretization-change-plan
protocol_version: 6.4.0
status: active-d1-renderer-repair-awaiting-bounded-equivalence-review
highest_affected_domain: D1
...
- D1 blob: `61cf2345e0d991b9598ba5a26fc58278c249cfb1`.
 ...
 inline math. The intended mathematics is unchanged. The reviewed target `2549dee7...` remains immutable historical review evidence.

Before stakeholder ratification, perform a bounded representation-equivalence check from `2549dee7...` to `991d7bb2...`. Gate C remains blocked until that check passes and the stakeholder ratifies the exact renderer-repaired target.
