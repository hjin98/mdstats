...
entry_condition: independent PASS for P6 revision 8 and P7 revision 4, followed by binding to the accepted post-P7 commit/tree
---

# Storage/I-O reset package authority — revision 3
...
```text
CODE-MLFF-TARGET-SIZE-V7-P6 revision 8 -> independent cleanup/cutover PASS
CODE-MLFF-TARGET-SIZE-V7-P7 revision 4 -> independent publication/qualification PASS
```
...
P6 revision 8 is intentionally limited to conservative transitional storage behavior: it removes retired destructive lifecycle authorization and leaves clean P3/P5 owners. P7 revision 4 then adds the final publication/qualification owner surface. Neither predecessor implements this storage reset.
