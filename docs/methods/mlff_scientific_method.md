...
For foundation adaptation (`naive_fine_tuning`, `multihead_replay`) the three post-selection thresholds are independently configurable policy parameters (`docs/methods/mlff_post_selection_threshold_policy.md`), with current generated defaults:
