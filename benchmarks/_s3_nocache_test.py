...
def run(a):
    ...
    for field in fields:
        ...
        opt=DensityHybridExecutorOptions(executor_mode=a.executor_mode,compute_tile_shape=tuple(a.tile_shape),min_fft_source_nodes=a.min_fft_source_nodes,fft_workers=a.fft_workers,cache_kernel_spectra=False)
