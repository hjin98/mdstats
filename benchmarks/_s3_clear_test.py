...
from mdstats.plotting.density_block_routing import get_periodic_kernel_block_routing, clear_density_routing_cache, density_routing_cache_info
from mdstats.plotting.density_sparse_optimization import aggregate_periodic_cic_sparse_optimized,get_periodic_gaussian_stencil_support, clear_density_optimization_caches, density_optimization_cache_info
...
def run(a):
    ...
    for field in fields:
        ...
        print('before-clear', density_optimization_cache_info().to_json_dict(), density_routing_cache_info().to_json_dict(), flush=True)
        del result, plan, at, rt, src, st, cic, samples, frac
        clear_density_optimization_caches(); clear_density_routing_cache()
        import gc; gc.collect()
        print('after-clear', density_optimization_cache_info().to_json_dict(), density_routing_cache_info().to_json_dict(), flush=True)
