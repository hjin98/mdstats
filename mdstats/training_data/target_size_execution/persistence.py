"""Crash-safe publication for target-size execution.

Provides advisory-locked, atomic create-or-verify publication for immutable raw
bytes (ExtXYZ, model checkpoints) and typed content-addressed JSON artifacts,
as well as atomic replacement for mutable pointers.  The advisory lock and
directory fsync primitives are owned by :mod:`mdstats.training_data.persistence`.
"""
...
from ..persistence import _FileLock, _lock_file_path, fsync_parent_directory
